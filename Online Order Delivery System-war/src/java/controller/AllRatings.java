 ...
 * @author ganye
 */
@WebServlet(name = "AllRatings", urlPatterns = {"/AllRatings"})
public class AllRatings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Ratings> allRatings = ratingsFacade.findAll();
        ...
        request.getRequestDispatcher("allratings.jsp").forward(request, response);
    }
